...
import {HUMAN_POSE_ESTIMATION_ENDPOINT } from "../api_endpoints";
import {
    Container,
    Form,
    Row,
    ...
    axios.defaults.headers.post["Accept"] = "application/json";
     ...
     return (
       <>
         ...
         <h1 style = {{textAlign:"center"}}>Monocular Human Pose Estimation</h1>
         <br/>
         <div style = {{textAlign:'center'}} >
               <p><strong>Pose Estimation of a single person</strong></p>
